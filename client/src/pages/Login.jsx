            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
                ...
                <div className="absolute top-8 left-8 z-20">
                    ...
                    >
                        ...
                        <div>
                            <p className="text-white font-bold text-base">1M+ Donors</p>
                            <p className="text-white/80 text-xs">Making a difference</p>
                        </div>
                    </motion.div>
                </div>
                ...
                <div className="relative z-10 flex flex-col justify-end p-8 lg:p-12 text-white h-full">
                    ...
                    >
                        ...
                        <h2 className="text-3xl lg:text-4xl font-bold font-serif leading-tight mb-4">
                            "Every great dream begins with a dreamer. We connect them with believers."
                        </h2>
                        <p className="text-base text-white/80 max-w-md">
                            Join our community of changemakers. Your next contribution could be the turning point in someone's story.
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-8 sm:px-10 lg:px-12 xl:px-20">
                ...
                >
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold font-serif text-slate-900 mb-2">Welcome back</h1>
                    ...
                    <div className="relative mb-6">
                        ...
                        <div className="relative flex justify-center text-xs">
                            <span className="bg-cream px-4 text-slate-500 font-medium">Or continue with email</span>
                        </div>
                    </div>
                    ...
                    <form className="space-y-8 mt-8" onSubmit={handleSubmit}>
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute right-0 top-2">
                                <a href="#" className="text-[10px] font-bold text-brand-dark hover:text-brand-dark/80 uppercase tracking-wider transition-colors">
                                    Forgot?
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-xs text-slate-600">
                            ...
                            <Link to="/register" className="font-bold text-brand-dark hover:text-brand-dark/80 transition-colors">
                                Create an account
                            </Link>
                        </p>
                    </div>
